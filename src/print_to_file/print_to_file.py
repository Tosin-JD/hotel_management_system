...
class PrintReceipt:
    ...
    def print_receipt(self):
        ...
        os.makedirs(documents_directory + "/guest_house/receipts", exist_ok=True)
        ...
        self.c = Canvas(
                        documents_directory + "/guest_house/receipts/receipt_" +
        ...
        self.c.drawString(250, 200, "GUEST HOUSE")
        ...
        self.c.drawString(150, 800, " Guest House , Abuja")
        ...
        phone_number = ["+234 000 000 0000", "+234 000 000 0000", "info@example.com"]
        self.c.setFont("Helvetica", size=12)
...
class PrintDeposits:
    ...
    def print_receipt(self):
        ...
        # Create a folder called _guest_house in the Documents directory
        os.makedirs(documents_directory + "/guest_house/deposits", exist_ok=True)
        ...
        self.c = Canvas(
                        documents_directory + "/guest_house/deposits/deposit_" +
                        self.reservation_data[1] + " " +
                        current_time_and_date + ".pdf"
                        )
        self.c.setFont("Helvetica-Bold", size=40)
        ...
        self.c.setFont("Helvetica", size=20)
        # Title and full Reservation Receipt
        self.c.drawString(150, 800, "Guest House")
        self.c.setFont("Helvetica-Bold", size=20)
        ...
        phone_number = ["+234 000 000 0000", "+234 000 000 0000", "infor@example.com"]
        self.c.setFont("Helvetica", size=12)
        self.c.drawString(20, 150, "Phone Number 1: " + phone_number[0])
        self.c.drawString(20, 130, "Phone Number 2: " + phone_number[1])
        self.c.drawString(20, 110, "Email: " + phone_number[2])
